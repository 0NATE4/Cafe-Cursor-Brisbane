...
1. Go to the [Security Advisories](https://github.com/AI-CYJ/Cursor-Academy-Skill/security/advisories) page.
...
- Feature requests or general bugs — use [Issues](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues) instead
