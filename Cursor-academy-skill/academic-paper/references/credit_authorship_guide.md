...
- Establishing the research question: examining the impact pathways of the QA-Agency accreditation system on teaching quality
...
- Providing authorization to use QA-Agency accreditation data
...
Higher Education Evaluation and Accreditation Council of Taiwan (QA-Agency).
```
