...
Academic Research Skills (ARS) is a **source-available academic research copilot framework** for noncommercial scholarly use. The reference distribution is a suite of Cursor rules and skills that assists human researchers through the full research-to-publication pipeline. Sibling distributions for other agent platforms ([e.g. Codex](https://github.com/AI-CYJ/Cursor-Academy-Skill-codex)) follow the same workflow content, the same human-in-the-loop design philosophy, and the same license terms; see [CONTRIBUTING.md § Platform ports](CONTRIBUTING.md#platform-ports-community-maintained-only).
...
```
Wu, C.-I. (2026). Academic Research Skills (Version 4.0) [Computer software]. https://github.com/AI-CYJ/Cafe-Cursor-Brisbane
```
