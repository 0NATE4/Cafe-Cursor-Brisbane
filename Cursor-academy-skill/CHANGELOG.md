...
Closes [#119](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/119). Refs [#120](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/120) P2-1, P2-2, P2-3, P2-4 (all four R8 findings).
...
**Parent issue:** [#103](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/103) — closes the L3 (claim-faithfulness) gap left open by v3.7.3 (which closed the locator-channel half). Spec: `docs/design/2026-05-15-issue-103-claim-alignment-audit-spec.md` + decision doc `docs/design/2026-05-15-issue-103-claim-alignment-audit-decision.md` (D1-D6 settled).
...
**Review trail (Step 13 dual-track, 2026-05-16):** 8 rounds codex (gpt-5.5 xhigh) + 1 round Gemini 3.1-pro-preview before Gemini quota exhausted. Trajectory R1 4P1+2P2 → R2 0P1+3P2 → R3 0P1+5P2 → R4 2P1+2P2 → R5 0P1+2P2+1P3 → R6 1P1+1P2 → R7 1P1+1P2+1P3 → **R8 0P1+4P2 → ship**. Per `feedback_codex_review_surface_loop_design_phase.md` design-phase P2 noise floor doesn't auto-converge; the user declared ship signal at R8 with all P0/P1 closed and 4 R8 P2 carried over to v3.8.1 ([#120](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/120)).

**Carry-over follow-up issues:**

- [#118](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/118) — uncited path NOT_VIOLATED swallow on judge failure (schema-level decision)
- [#119](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/119) — nested schema-invalid shapes still crash invariant helpers
- [#120](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/120) — 4 R8 P2 findings (CV-INV-4 dedupe scope / invariant walker short-circuit / judgment + method type-check before set membership)
...
**Parent issue:** [#115](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/115) — follow-up to #105 PR codex round-5 [P2]×2 findings (R5-2 throttle + R5-3 outage latch). Both deferred during #105 ship per architectural-inflection discipline; this entry closes the SS-client maturity gap.
...
**Parent issue:** [#104](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/104). Doc-only — no code changes.
...
**Parent issue:** [#111](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/111), follow-up to #108 (PR #110, merged 70c8678) round-8 P2 #1. Design: `docs/design/2026-05-15-issue-111-slr-lineage-emission-design.md`.
...
> CLI / VS Code / JetBrains via `/plugin marketplace add AI-CYJ/Cursor-Academy-Skill`
...
- This patch is a scope change from the v3.6.5.2 originally forecast in the
  ...
  removed here.
- Issue [#44](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/44)
...
- Issue [#44](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/44) (philpav)
...
- Original IS Basket of 8 proposed and drafted by [@mchesbro1](https://github.com/mchesbro1) — [Issue #5](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/5). Extended to Basket of 11 by [@cloudenochcsis](https://github.com/cloudenochcsis) — [Issue #7](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/7), [PR #8](https://github.com/AI-CYJ/Cursor-Academy-Skill/pull/8). Source: [AIS Senior Scholars' List of Premier Journals](https://aisnet.org/research/seniorscholarsbasket/)
