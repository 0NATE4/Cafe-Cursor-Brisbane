...
**Canonical location**: `shared/collaboration_depth_rubric.md` in `AI-CYJ/Cursor-Academy-Skill`. External consumers should reference by stable URL; do not vendor (bump the `rubric_version` field on any modification).
