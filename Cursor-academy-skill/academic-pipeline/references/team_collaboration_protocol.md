...
Guidelines for coordinating multi-person academic research teams using the pipeline. Cursor / your AI Agent runs as a single-user session; this protocol documents the **human coordination layer** that wraps around pipeline executions.
...
- Cursor / your AI Agent runs as a single-user session; this protocol documents the HUMAN coordination layer
