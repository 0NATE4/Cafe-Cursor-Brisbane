...
**目標：** 最小工程量讓使用者可以 `/plugin marketplace add AI-CYJ/Cursor-Academy-Skill` + `/plugin install ars`，4 個既有 skill 自動被載入。
...
```json
{
  ...
  "author": {
    "name": "Yujun",
    "url": "https://github.com/AI-CYJ"
  },
  "homepage": "https://github.com/AI-CYJ/Cursor-Academy-Skill",
  "repository": "https://github.com/AI-CYJ/Cursor-Academy-Skill",
  "license": "Other",
...
\`\`\`
/plugin marketplace add AI-CYJ/Cursor-Academy-Skill
...
**驗收：** 在另一台機器 `/plugin marketplace add AI-CYJ/Cursor-Academy-Skill` 後開 auto-update，repo push 新 commit 後重啟 Claude Code 自動拉新版。
