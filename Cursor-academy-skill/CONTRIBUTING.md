...
ARS uses the standard **fork-and-PR** workflow. Fork the repo on GitHub, clone your fork, create a branch, make your changes, push to your fork, then open a PR against `AI-CYJ/Cafe-Cursor-Brisbane`.
...
The repo is maintained by [Yujun](https://github.com/AI-CYJ). Built on the foundation of Academic Research Skills by Yujun (AI-CYJ). The maintainer has final say on all merges.
...
3. **No detection evasion** — features designed to make AI-generated text harder to detect (as opposed to higher quality) are out of scope. See [Issue #3](https://github.com/AI-CYJ/Cursor-Academy-Skill/issues/3) for context.
